...
void setup() {
  size(400, 400);
  circulo1 = new Circulo(0,0,50,70);
  circulo2 = new Circulo(width,0,50,50);
  circulo3 = new Circulo(0,height,50,60);
  circulo4 = new Circulo(width,height,50,80);
}
void draw() {
  //e=e+vt
  circulo1.acc++;
  //circulo.x = circulo.x + circulo.speed;
  circulo1.x += circulo1.speed + circulo1.acc; //no multiplico por el tiempo ya que esta dado por el draw
